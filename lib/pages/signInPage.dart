...
class _authenticationPageState extends State<authenticationPage> {
  ...
  void showDialogForSignInError(dynamic error) {
    ...
    var authenerror = {
      ...
      'userErrorMessage':
          'Please input a correct email address or Your email has not been confirmed.',
                            ...
                            child: Material(
                              ...
                              child: InkWell(
                                onTap: () async {
                                  ...
                                  if (_formfieldKey_email.currentState
                                          .validate() &&
                                      _formfieldKey_password.currentState
                                          .validate()) {
                                    userdata.signIn(
                                        _formfieldKey_email.currentState.value,
                                        _formfieldKey_password
                                            .currentState.value);
                                    userdata.getResult().then((onValue) {
                                      ...
                                      Timer _time =
                                        ...
                                        Navigator.push(
                                            ...
                                            MaterialPageRoute(
                                                builder:
                                                    (context) => /*mainPage(user)*/ decisionPage()));
                                      });
                                    }).catchError((onError) {
